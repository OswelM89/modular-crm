...
>(({ defaultOpen = true, open: openProp, onOpenChange, className, style, children, collapsedWidth, ...props }, ref) => {
  ...
  const contextValue = React.useMemo<SidebarContext>(
    ...
    [state, open, setOpen, toggleSidebar, collapsed]
  )
    ...
    >
      ...
      >
        <div
          ...
          className="flex h-full w-[--sidebar-width] flex-col group-data-[collapsible=icon]:w-[--sidebar-width-collapsed]"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:bg-sidebar-border",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      {showIcon && (
        <div
          className="flex size-4 rounded-sm bg-sidebar-border"
          data-sidebar="menu-skeleton-icon"
        />
      )}
      <div
        className="h-4 flex-1 max-w-[--skeleton-width] rounded-sm bg-sidebar-border"
