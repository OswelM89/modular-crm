...
export function ContactForm({ isOpen, onClose, onSubmit }: ContactFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 h-screen">
      ...
      {/* Sidebar */}
      <div className="absolute right-0 top-0 bottom-0 w-full sm:w-96 bg-white flex flex-col h-screen">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0 m-0">
